...
</table><script language="JavaScript">locationid.innerHTML = "发布文章";</script>
<script language=JavaScript>
var _maxCount = '10240';
...
<table class="Usertableborder" cellspacing="1" cellpadding="3" align="center" border="0">
	...
	<form action="<%=url%>/servletsuserarticle?action=add" method="post" onsubmit="return doSubmit()" name="myform">
	<input type="hidden" name="ChannelID" value="1"/>
		...
		<tr>
			...
			<td class="usertablerow1"><input size="30" name="author" value="<%=request.getSession().getAttribute("name")%>" type="text" readonly/> </td>
		</tr>
		<tr>
		...
		<tr>
			<td class="usertablerow1" colspan="2"><div><INPUT type="hidden" name="content1" value=""><IFRAME ID="eWebEditor1" src="<%=url%>/eWebEditor.jsp?id=content1&style=standard" frameborder="0" scrolling="no" width="580" height="350"></IFRAME></div></td>
		</tr>
		<tr>
			...
			<td class="usertablerow2">发布时间:<input type="text" name="nowtime" value="<%=time()%>" readonly size="40"></td>
		</tr>
				<tr align="center">
