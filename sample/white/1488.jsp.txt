...
<body>
	...
	<table width="100%" cellpadding="0" cellspacing="0" class="dl_su">
		<tr>
			<td align="left" >
					按企业名称:<input name="s_cust_name" type="text" />
	...
	<table width="100%" cellpadding="1" cellspacing="1" class="listtab" border="0">
		...
		<tr>
			<td width="5%" align="center"><input type="checkbox" name="checkone<%=i %>" id="checkone<%=i %>" value="<%=cust_id %>" /></td>
		  	...
		  	<td><a href="bizlistdl.jsp?cust_name=<%=cust_name %>&cust_id=<%=cust_id %>&area_attr=<%=area_attr%>"><%=cust_name%></a></td>
