 ...
 <input name="pyKey" id="pyKey" type="text" onKeyUp="if(!/^[A-Z]*$/.test(this.value))this.value='A'" value="<%=pyKey %>" maxlength="1" size="4"/>
		...
		<tr>
			<td align="right" width="10%">
				所属平台:			</td>
			<td>
				 <input name="is_platform" id="is_platform1" type="radio" value="0" <%if(is_platform.equals("0"))out.print("checked");%>/>8点商城
				 <input name="is_platform" id="is_platform2" type="radio" value="1" <%if(is_platform.equals("1"))out.print("checked");%>/>8点商铺
				</td>
		</tr>
