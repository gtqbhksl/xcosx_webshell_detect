...
<body>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dl_bg">
		<tr>
			<td width="90%">
				<input type="button" name="delInfo" onclick="updatestate('c')" value="审核通过" class="buttab"/>
				<input type="button" name="delInfo" onclick="updatestate('b')" value="审核不通过" class="buttab"/>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dl_bg">
		<tr>
			<td width="90%">
				<input type="button" name="delInfo" onclick="delIndexInfo('c')" value="审核通过" class="buttab"/>
				<input type="button" name="delInfo" onclick="delIndexInfo('b')" value="审核不通过" class="buttab"/>
			    <input type="button" name="delInfo" onclick="delIndexInfo()" value="删除" class="buttab"/>
			   </td>
			<td>
				总计:<%=counter %>条
