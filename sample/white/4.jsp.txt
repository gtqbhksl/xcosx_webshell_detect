...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" >
	...
	<head>
		<title>CREATE NEWS GU - Step 1 of 2</title>
				...
				<div id="inner">
					<div id="leftcol" >
							...
							<%
								...
								PropertySet propertySet = workflowController.getPropertySet(infoGluePrincipal, new Long(workflowId).longValue());
								propertySet.setString("parentContentId", "" + request.getParameter("parentContentId"));
								propertySet.setString("contentTypeDefinitionId", "" + request.getParameter("contentTypeDefinitionId"));
								propertySet.setString("repositoryId", "" + request.getParameter("repositoryId"));
								propertySet.setString("languageId", "" + request.getParameter("languageId"));
