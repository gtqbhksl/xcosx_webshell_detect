...
Sub NewsList()
	...
	<table cellpadding="3" cellspacing="1" border="0" align="center" width="100%">
		...
		<tr>
			...
			<td class="<%If i Mod 2 = 1 Then %>td1<%Else%>td2<%End If%>" align=center>
			<input type="submit" class="button"  onclick="this.form.Act.value='EditNewsInfo';Selchecked(this.form.DelNodes,<%=i%>);" value="编辑">
			<input type="submit" class="button"  onclick="this.form.Act.value='CopyNewsInfo';Selchecked(this.form.DelNodes,<%=i%>);" value="复制">
