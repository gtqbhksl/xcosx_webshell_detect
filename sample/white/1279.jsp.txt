								...
								<td width="70">
									<%
										...
										<%}else{%>
											...
											<a href="#" onclick="updateTradeState('<%=voucher_code%>','<%=voucher_pwd%>','<%=order_no%>','1','a_3<%=i %>')" id="a_3<%=i %>" >
												<div style="background:url(/program/admin/images/orderbg.jpg) repeat-x;width:57px;height:20px;line-height:20px;color:#fff;cursor:pointer;text-align:center;">恢复使用</div>
											</a>
										<%}
									%>
