...
<title>系统配置 - Powered By MyExam</title>
...
<body>
	<div class="header">
		<div class="title">MyExam 安装程序 - 系统配置</div>
			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						<td>数据库名称:</td>
						<td>
							<input type="text" id="databaseName" name="databaseName" class="text" value="MyExam" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2013 MyExam.net All Rights Reserved.</p>
	</div>
</body>
</html>