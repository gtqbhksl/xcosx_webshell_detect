...
<s:form name="form" id="form" method="POST" action="addUser!save">
  <table width="1024" border="0" align="center">
    <tr>
      ...
      <td width="814"><div align="center"><span class="STYLE2">请详细填写您的个人资料！</span></div></td>
    </tr>   
    <tr>
      <td colspan="2"><table width="100%" align="center" background="images/regpagebg.jpg">
        <tr><td>
          <div align="right">
            <s:textfield  name="username" label="会员名" align="left"/>
          </div></td></tr>
        <tr><td>
          <div align="right">
   ...
   doubleName="city" formName="form" doubleList="#area[top]" />
      ...
      <tr><td>
          ...
          <div align="right">
            ...
            <tr><td>
          <div align="right">
            <s:textfield  name="telphone" label="电话" align="left" value="-"/>
          </div></td></tr>
            <tr><td>
          <div align="right">
            <s:textfield  name="mobilephone" label="手机" align="left"/>
             ...
             <tr><td>
          <div align="right">
            <s:textfield  name="email" label="邮箱" align="left" value="@" />
          </div></td></tr>
        <tr><td>   
          <div align="right">
